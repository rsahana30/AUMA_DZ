  ...
  const handleUpload = async () => {
    ...
    try {
      await Promise.all(excelData.map(async (row) => {
        await axios.post("http://localhost:5000/api/save-multiturn", row);
      }));
  ...
  return (
    <div className="container mt-4">
      ...
      <p>
        ...
        <a href="/multiturn.xlsx" download className="btn btn-link">
          Download Sample
        </a>
      </p>
      <div className="mb-3">
...
export default ExcelUploadMultiturn;